...
Here we will describe the basic file structure of the project.
...
| `src/applications`         | Preconfigured ArgoCD [Applications](./application-deployment/index.md), for deploy different type of Services.    |
