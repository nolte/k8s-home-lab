...
```sh
cat ./clusterconfig/talosconfig | gopass insert -f private/network/talos-confgis/smart-home-02
...
export TALOS_NODE_CONFIG=$(pwd)/clusterconfig/smart-home-02-k8ssmarthome02.yaml
```
